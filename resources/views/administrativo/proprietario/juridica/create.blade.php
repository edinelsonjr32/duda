    ...
    <section class="content">
            <div class="row">
              <div class="col-xs-12">
                  ...
                  <form method="POST" action="{{ route('administrativo.proprietario.juridico.store') }}">
                      @csrf
                      ...
                      <div class="box box-success">
                          ...
                          <div class="box-body">
                              <div class="form-group col-md-6">
                                  ...
                                  <input type="text" value="{{ old('nome_empresa') }} "class="form-control" placeholder="Nome" name="nome_empresa">
                                  @error('nome_empresa')
                              ...
                              <div class="form-group col-md-6">
                                  ...
                                  <input type="text" value="{{ old('nome_fantasia') }}" class="form-control" placeholder="Nome Fantasia" name="nome_fantasia">
                                    @error('nome_fantasia')
                                  <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                              ...
                              <div class="form-group col-md-4">
                                  <label>CNPJ</label>
                                  <input type="text" value="{{ old('cnpj') }}" class="form-control" placeholder="CNPJ" name="cnpj">
                                    @error('cnpj')
                                  <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                              ...
                              <div class="form-group col-md-4">
                                  <label>Email</label>
                                  <input type="text" value="{{ old('email') }}" class="form-control" placeholder="Email" name="email">
                                    @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                            </span>
                              ...
                              <div class="form-group col-md-4">
                                  ...
                                  <input type="text" value="{{ old('contrato_social') }}" class="form-control" placeholder="Contrato Social" name="contrato_social">

    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="/admin/proprietario/fisica/index"><i class="fa fa-user-secret"></i> Proprietário</a></li>
            ...
            <div class="row">
                <div class="col-xs-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($imovel->aluguel == 1)
                                                ...
                                                <a class=" btn btn-block btn-success" href="{{route('administrativo.imoveis.aluguel.detail', $imovel->id)}}"><span class="fa fa-eye"></span></a>

                                            @elseif($imovel->venda == 1)
                                                <a class=" btn btn-block btn-success" href="{{route('administrativo.imoveis.venda.detail', $imovel->id)}}"><span class="fa fa-eye"></span></a>
                    ...
                    <div class="box box-warning ">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form action="{{route('administrativo.proprietario.juridico.documento.store')}}" enctype="multipart/form-data" method="post">
                            ...
                            @foreach($documentos as $dado)
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <a type="button" href="{{route('administrativo.proprietario.fisico.documento.download', ['id' => $dado->id])}}" class="btn btn-block btn-success"><span class="fa fa-download"></span></a>
                                            </div>
                                            <div class="col-md-6">
                                                <a type="button" href="{{route('administrativo.proprietario.fisico.documento.delete', ['id' => $dado->id])}}" class="btn btn-block btn-danger"><span class="fa fa-trash"></span></a>
                                            </div>
                                        </div>

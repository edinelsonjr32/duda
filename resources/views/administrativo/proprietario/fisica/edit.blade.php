        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                @endif
                    ...
                    <form method="POST" action="{{ route('administrativo.proprietario.fisico.update', ['proprietario'=> $dadosProprietario->id]) }}">
                        @csrf
                        @method('PUT')
                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-md-3">
                                <label>Email</label>
                                <input  id="email" type="text" class="form-control" value="{{ old('email') ?? $dadosProprietario->email}}"  name="email">
                                @error('email')
                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="box-body">
                            <div class="form-group col-md-4">
                                ...
                                <select class="form-control" name="tipo_conta">
                                    <option value="1" {{ (old('estado_civitipo_contal') == 1 ? 'selected' : ($dadosProprietario->tipo_conta  == 1 ? 'selected' : '')) }}>Corrente</option>
                                    <option value="2" {{ (old('estado_civitipo_contal') == 2 ? 'selected' : ($dadosProprietario->tipo_conta  == 2 ? 'selected' : '')) }}>Poupança</option>
                                </select>
                            </div>
                            <div class="form-group col-md-8">

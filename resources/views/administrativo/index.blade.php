...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="/home"><i class="fa fa-dashboard"></i> Administrativo</a></li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4 col-md-offset-4 border-right">
                                                    <div class="description-block">
                                                        ...
                                                        <span class="description-text">Administrativo</span>
                                                    </div>
                                                    <!-- /.description-block -->
                                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-xs-12">
                                    ...
                                    <div class="small-box bg-lime">
                                        ...
                                        <a href="{{route('administrativovisita.index')}}" class="small-box-footer">Acessar <i class="fa fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                            </div>

                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 col-xs-4">
                                                        <a class=" btn btn-block btn-primary" href="{{route('visita.edit', $dado->id)}}"><span class="fa fa-pencil"></span></a>
                                                    </div>
                                                    <div class="col-md-4 col-xs-4">
                                                        <a  class=" btn btn-block btn-danger" href="{{route('admin.visita.destroy', $dado->id)}}"><span class="fa fa-trash"></span></a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 col-xs-4">
                                                        <a  class=" btn btn-block btn-danger" href="{{route('visita.destroy', $dado->id)}}"><span class="fa fa-trash"></span></a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>

            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box box-success">
                        <form method="POST" action="{{ route('admin.imoveis.venda.update', ['id' => $imovel->id]) }}">
                            @csrf
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input id="valor_venda2" type="text" class="form-control @error('valor_venda') is-invalid @enderror" name="valor_venda" value="{{ number_format(old('valor_venda') ?? $imovel->valor_venda, 2, ',', '.') }}"  required autocomplete="valor_venda" autofocus onKeyPress="return(MascaraMoeda(this,'.',',',event))">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <input id="condominio" type="text" class="form-control @error('condominio') is-invalid @enderror" name="condominio" value="{{ number_format(old('condominio') ?? $imovel->condominio, 2, ',', '.') }}"  autocomplete="condominio" autofocus onKeyPress="return(MascaraMoeda(this,'.',',',event))">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2">
                                        <input id="area_util" type="text" class="form-control @error('area_util') is-invalid @enderror" name="area_util" value="{{ number_format(old('area_util') ?? $imovel->area_util, 2, ',', '.')}}"  autocomplete="area_util" autofocus>
                                    ...
                                    <div class="col-md-2">
                                        <input id="area_total" type="text" class="form-control @error('area_total') is-invalid @enderror" name="area_total" value="{{ number_format(old('area_total') ?? $imovel->area_total, 2, ',', '.')}}"  autocomplete="area_total" autofocus>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input id="tamanho_frente" type="text" class="form-control @error('tamanho_frente') is-invalid @enderror" name="tamanho_frente" value="{{  number_format(old('tamanho_frente') ?? $imovel->tamanho_frente, 2, ',', '.')}}"  autocomplete="tamanho_frente" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2">
                                        <input id="tamanho_fundo" type="text" class="form-control @error('tamanho_fundo') is-invalid @enderror" name="tamanho_fundo" value="{{ number_format(old('tamanho_fundo') ?? $imovel->tamanho_fundo, 2, ',', '.')}}"  autocomplete="tamanho_fundo" autofocus>
                                ...
                                <a href="{{route('admin.imoveis.venda.index')}}" class="btn btn-default col-md-5" data-dismiss="modal">Sair</a>

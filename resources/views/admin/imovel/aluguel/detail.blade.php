                ...
                <div class="row">
                    <div class="col-md-8">
                            ...
                            <div class="box-footer no-padding">
                                <ul class="nav nav-stacked">
                                    ...
                                    @elseif($dados->taxas_extras !== null)
                                        <li><a href="#">Taxas rateio<span class="pull-right badge bg-green">R${{number_format($dados->taxas_extras, 2, ',', '.')}}</span></a></li>
                                    @endif
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <a type="button" href="{{route('admin.imoveis.aluguel.imagem.principal.desativar', ['id' => $imagem->id])}}" class=" btn btn-block btn-success"><span class="fa fa-check"></span></a>
                                                    </div>
                                                    @else
                                                        <div class="col-md-12">
                                                            <a type="button" href="{{route('admin.imoveis.aluguel.imagem.principal.ativar', ['id' => $imagem->id])}}" class="btn btn-warning btn-block"><span class="fa  fa-times"></span></a>
                                                        </div>
                                                    @endif
                                                </div>
                                            ...
                                            <td>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <a type="button" href="{{route('admin.imoveis.aluguel.imagem.principal.delete', ['id' => $imagem->id])}}" class="btn btn-block btn-danger"><span class="fa fa-trash"></span></a>
                                                    </div>
                                                </div>
                        ...
                        <div class="box box-success ">
                            ...
                            <!-- /.box-header -->
                            <div class="box-body">
                                <form action="{{route('admin.imoveis.aluguel.imagem.store')}}" enctype="multipart/form-data" method="post">
                                    ...
                                    @foreach($imagensImoveis as $active)
                                        @if($contador2 == 0)
                                            <div class="item active">
                                                <img src="{{ URL::to('/') }}/imovel/images/{{ $active->path }}" alt="First slide" height="300px">
                                            </div>
                                            <?php
                                            $contador2 = 1;
                                            ?>
                                        @elseif($contador2 !== 0)
                                            <div class="item">
                                                <img src="{{ URL::to('/') }}/imovel/images/{{ $active->path }}" alt="Second slide" height="300px">
                                            </div>
                                            <?php

                    ...
                    <div class="box box-success">
                        ...
                        <div class="tab-content">
                            <div id="home" class="tab-pane fade in active">
                                ...
                                @endif
                                <form method="POST" action="{{ route('admin.imoveis.store') }}">
                                    @csrf
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input id="valor_venda" type="text" class="form-control @error('valor_venda') is-invalid @enderror" name="valor_venda" value="{{ old('valor_venda') }}"  required autocomplete="valor_venda" autofocus onKeyPress="return(MascaraMoeda(this,'.',',',event))">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-3">
                                                <input id="condominio" type="text" class="form-control @error('condominio') is-invalid @enderror" name="condominio" value="{{ old('condominio') }}"  autocomplete="condominio" autofocus onKeyPress="return(MascaraMoeda(this,'.',',',event))">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2">
                                                <input id="garagem_coberta" type="text" class="form-control @error('garagem_coberta') is-invalid @enderror" name="garagem_coberta" value="{{ old('garagem_coberta') }}"  autocomplete="Nome" autofocus>
                                            ...
                                            <div class="col-md-2">
                                                <input id="area_util" type="text" class="form-control @error('area_util')  is-invalid @enderror" name="area_util" value="{{ old('area_util') }}"  autocomplete="area_util" autofocus onKeyPress="return(MascaraMoeda(this,'.',',',event))">
                                            ...
                                            <div class="col-md-2">
                                                <input id="area_total" type="text" class="form-control @error('area_total') is-invalid @enderror" name="area_total" value="{{ old('area_total') }}"  autocomplete="area_total" autofocus onKeyPress="return(MascaraMoeda(this,'.',',',event))">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2">
                                                <input id="tamanho_frente" type="text" class="form-control @error('tamanho_frente') is-invalid @enderror" name="tamanho_frente" value="{{ old('tamanho_frente') }}"  autocomplete="tamanho_frente" autofocus onKeyPress="return(MascaraMoeda(this,'.',',',event))">
                                            ...
                                            <div class="col-md-2">
                                                <input id="tamanho_fundo" type="text" class="form-control @error('tamanho_fundo') is-invalid @enderror" name="tamanho_fundo" value="{{ old('tamanho_fundo') }}"  autocomplete="tamanho_fundo" autofocus onKeyPress="return(MascaraMoeda(this,'.',',',event))">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-3">
                                                <input id="rua" type="text" class="form-control @error('endereco') is-invalid @enderror" name="endereco" value="{{ old('endereco') }}"  autocomplete="endereco" autofocus>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2">
                                                <input id="numero" required type="text" class="form-control @error('numero') is-invalid @enderror" name="numero" value="{{ old('numero') }}"  autocomplete="numero" autofocus>
                                            ...
                                            <div class="col-md-2">
                                                <input id="bairro" type="text" class="form-control @error('bairro') is-invalid @enderror" name="bairro" value="{{ old('bairro') }}"  autocomplete="bairro" autofocus>
                                            ...
                                            <div class="col-md-2">
                                                <input id="cidade" type="text" class="form-control @error('cidade') is-invalid @enderror" name="cidade" value="{{ old('cidade') }}"  autocomplete="cidade" autofocus>
                                            ...
                                            <div class="col-md-2">
                                                <input id="uf" type="text" class="form-control @error('estado') is-invalid @enderror" name="estado" value="{{ old('estado') }}"  autocomplete="estado" autofocus>
                                ...
                                <form method="POST" action="{{ route('admin.imoveis.store') }}">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2">
                                                <input id="area_total" type="text" class="form-control @error('area_total') is-invalid @enderror" name="area_total" value="{{ old('area_total') }}"  autocomplete="area_total" autofocus>

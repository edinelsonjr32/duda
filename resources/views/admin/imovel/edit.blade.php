                    ...
                    <div class="box box-success">
                        @if($imovel->venda == 1)
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#home">Venda</a></li>
                                <li><a data-toggle="tab" href="#menu1">Aluguel</a></li>
                            </ul>
                            <div class="tab-content">
                                <div id="home" class="tab-pane fade in active">
                                    ...
                                    @endif
                                    <form method="POST" action="{{ route('admin.imoveis.update', ['id' => $imovel->id]) }}">
                                        @csrf
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type="hidden" name="aluguel" value="0">
                                                ...
                                                <div class="col-md-3">
                                                    <select class="form-control select2" style="width: 100%;" name="proprietario">
                                                        @foreach($proprietarios as $proprietario)
                                                            <option value="{{$proprietario->id}}" {{ (old('proprietario') == $proprietario->id ? 'selected'  : ($imovel->proprietario_id  == $proprietario->id ? 'selected' : '')) }}>{{$proprietario->nome}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <label for="valor_venda2" class="col-md-1 col-form-label text-md-right">Venda</label>
                                                <div class="col-md-5">
                                                    <input id="valor_venda2" type="text" class="form-control @error('valor_venda') is-invalid @enderror" name="valor_venda" value="{{ old('valor_venda') ?? $imovel->valor_venda }}"  required autocomplete="valor_venda" autofocus onKeyPress="return(MascaraMoeda(this,'.',',',event))">
                                                ...
                                                <div class="col-md-5">
                                                    <input id="imposto" type="text" class="form-control @error('imposto') is-invalid @enderror" name="impostos" value="{{ old('impostos') ?? $imovel->impostos}}"  autocomplete="imposto" autofocus>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-3">
                                                    <input id="condominio" type="text" class="form-control @error('condominio') is-invalid @enderror" name="condominio" value="{{ old('condominio') ?? $imovel->condominio}}"  autocomplete="condominio" autofocus onKeyPress="return(MascaraMoeda(this,'.',',',event))">
                                            ...
                                            <div class="form-group row">
                                        <textarea id="editor1" name="descricao" rows="10" cols="190">
                                                <?php
                                            ...
                                            <div class="form-group row">
                                                <label for="tamanho_frente" class="col-md-1 col-form-label text-md-right">Tamanho frente</label>
                                                <div class="col-md-2">
                                                    <input id="tamanho_frente" type="text" class="form-control @error('tamanho_frente') is-invalid @enderror" name="tamanho_frente" value="{{ old('tamanho_frente') ?? $imovel->tamanho_frente}}"  autocomplete="tamanho_frente" autofocus>

                                                    @error('tamanho_frente')
                                                    <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                    @enderror
                                                </div>
                                                <label for="tamanho_fundo" class="col-md-1 col-form-label text-md-right">Tamanho Fundo</label>

                                                <div class="col-md-2">
                                                    <input id="tamanho_fundo" type="text" class="form-control @error('tamanho_fundo') is-invalid @enderror" name="tamanho_fundo" value="{{ old('tamanho_fundo') ?? $imovel->tamanho_fundo}}"  autocomplete="tamanho_fundo" autofocus>
                                            ...
                                            <div class="form-group row">
                                                <label for="latitude" class="col-md-1 col-form-label text-md-right">Latitude</label>

                                                <div class="col-md-5">
                                                    <input id="latitude" type="text" class="form-control @error('latitude') is-invalid @enderror" name="latitude" value="{{ old('latitude') ?? $imovel->latitude}}"  autocomplete="latitude" autofocus>
                                                ...
                                                <label for="longitude" class="col-md-1 col-form-label text-md-right">Longitude</label>


                                                <div class="col-md-5">
                                                    <input id="longitude" type="text" class="form-control @error('longitude') is-invalid @enderror" name="longitude" value="{{ old('longitude') ?? $imovel->longitude}}"  autocomplete="longitude" autofocus>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="checkbox">
                                                    <label class="col-md-2">
                                                        <input type="checkbox" name="documentado" {{ (old('documento') == 'on' || old('documento') == true ? 'checked' : ($imovel->documento == true ? 'checked' : '')) }}>
                                                        Documentado
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                            ...
                                            <a href="{{route('admin.usuario.index')}}" class="btn btn-default col-md-5" data-dismiss="modal">Sair</a>
                                            <button type="submit" class="btn btn-primary col-md-5 col-md-offset-2">Salvar</button>
                                            <br>
                                            <br>
                                    ...
                                    <form method="POST" action="{{ route('admin.imoveis.update', ['id' => $imovel->id]) }}">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input onKeyPress="return(MascaraMoeda(this,'.',',',event))" id="valor_aluguel" type="text" class="form-control @error('valor_aluguel') is-invalid @enderror" name="valor_aluguel" value="{{ old('valor_aluguel') ?? $imovel->valor_aluguel}}"  autocomplete="valor_aluguel" autofocus>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-3">
                                                    <input onKeyPress="return(MascaraMoeda(this,'.',',',event))" id="condominio" type="text" class="form-control @error('condominio') is-invalid @enderror" name="condominio" value="{{ old('condominio') ?? $imovel->condominio}}"  autocomplete="condominio" autofocus>
                                                ...
                                                <div class="col-md-3">
                                                    <input id="taxas_extras" onKeyPress="return(MascaraMoeda(this,'.',',',event))" type="text" class="form-control @error('taxas_extras') is-invalid @enderror" name="taxas_extras" value="{{ old('taxas_extras') ?? $imovel->taxas_extras}}"  autocomplete="taxas_extras" autofocus>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label for="matricula_cosanpa" class="col-md-2 col-form-label text-md-right">Matrícula Cosampa</label>
                                                <div class="col-md-4">
                                                    <input id="matricula_cosanpa" type="text" class="form-control @error('matricula_cosanpa') is-invalid @enderror" name="matricula_cosanpa" value="{{ old('matricula_cosanpa') ?? $imovel->matricula_cosampa}}"  autocomplete="matricula_cosanpa" autofocus>
                        ...
                        @elseif($imovel->aluguel == 1)
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#home">Aluguel</a></li>
                                <li><a data-toggle="tab" href="#menu1">Venda</a></li>
                            </ul>
                            <div class="tab-content">
                                <div id="menu1" class="tab-pane fade in active">
                                    ...
                                    <form method="POST" action="{{ route('admin.imoveis.update', ['id' => $imovel->id]) }}">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group row">
                                                <label for="valor_venda" class="col-md-1 col-form-label text-md-right">Venda</label>
                                                <div class="col-md-5">
                                                    <input id="valor_venda" type="text" class="form-control @error('valor_venda') is-invalid @enderror" name="valor_venda" value="{{ old('valor_venda') ?? $imovel->valor_venda }}"  required autocomplete="valor_venda" autofocus onKeyPress="return(MascaraMoeda(this,'.',',',event))">

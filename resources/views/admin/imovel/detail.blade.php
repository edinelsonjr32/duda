                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="box box-widget widget-user-2">
                            ...
                            <div class="box-footer no-padding">
                                <ul class="nav nav-stacked">
                                    ...
                                    @if($dados->aluguel == 1)
                                        <li><a href="#">Valor Aluguel<span class="pull-right badge bg-blue">R$:{{number_format($dados->valor_aluguel, 2, ',', '.')}}</span></a></li>
                                    @endif
                                    @if($dados->venda == 1)
                                        <li><a href="#">Valor Venda<span class="pull-right badge bg-blue">R$:{{number_format($dados->valor_venda, 2, ',', '.')}}</span></a></li>
                                    @endif

                                    @if($dados->impostos == null )
                                    @elseif($dados->impostos !== null)
                                        <li><a href="#">Impostos <span class="pull-right badge bg-blue">R$:{{number_format($dados->impostos, 2, ',', '.')}}</span></a></li>
                                    @endif
                                    ...
                                    @elseif($dados->area_total !== null)
                                        <li><a href="#">Área Total<span class="pull-right badge bg-green">{{$dados->area_total}}</span></a></li>
                                    @endif
                                    @if($dados->area_util == null )
                                    @elseif($dados->area_util !== null)
                                        <li><a href="#">Área Útil<span class="pull-right badge bg-green">{{$dados->area_util}}</span></a></li>
                                    @endif

                                    @if($dados->taxas_extras == null )
                                    @elseif($dados->taxas_extras !== null)
                                        <li><a href="#">Taxas Extras<span class="pull-right badge bg-green">R$:{{number_format($dados->taxas_extras, 2, ',', '.')}}</span></a></li>
                                    @endif


                                    @if($dados->contribuicao == null )
                                    @elseif($dados->contribuicao !== null)
                                        <li><a href="#">Contribuição<span class="pull-right badge bg-green">R$:{{number_format($dados->contribuicao, 2, ',', '.')}}</span></a></li>
                                    @endif

                                    @if($dados->impostos == null )
                                    @elseif($dados->impostos !== null)
                                        <li><a href="#">Imposto<span class="pull-right badge bg-green">R$:{{number_format($dados->impostos, 2, ',', '.')}}</span></a></li>
                                    @endif

                                    @if($dados->condominio == null )
                                    @elseif($dados->condominio !== null)
                                        <li><a href="#">Condominio<span class="pull-right badge bg-green">R$:{{number_format($dados->condominio, 2, ',', '.')}}</span></a></li>
                                    @endif
                                    ...
                                    @elseif($dados->matricula_celpa !== null)
                                        <li><a href="#">Matricula Cepla<span class="pull-right badge bg-green">{{$dados->matricula_celpa}} M²</span></a></li>
                                    @endif


                                    @if($dados->matricula_cosanpa == null )
                                    @elseif($dados->matricula_cosanpa !== null)
                                        <li><a href="#">Matricula Cosanpa<span class="pull-right badge bg-green">{{$dados->matricula_cosanpa}} M²</span></a></li>
                                    @endif
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <a type="button" href="{{route('admin.imoveis.imagem.principal.desativar', ['id' => $imagem->id])}}" class=" btn btn-block btn-success"><span class="fa fa-check"></span></a>
                                                    </div>
                                                    @else
                                                        <div class="col-md-12">
                                                            <a type="button" href="{{route('admin.imoveis.imagem.principal.ativar', ['id' => $imagem->id])}}" class="btn btn-warning btn-block"><span class="fa  fa-times"></span></a>
                                                        </div>
                                                    @endif
                                                </div>
                                            ...
                                            <td>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <a type="button" href="{{route('admin.imoveis.imagem.principal.delete', ['id' => $imagem->id])}}" class="btn btn-block btn-danger"><span class="fa fa-trash"></span></a>
                                                    </div>
                                                </div>
                        ...
                        <div class="box box-success ">
                            ...
                            <!-- /.box-header -->
                            <div class="box-body">
                                <form action="{{route('admin.imoveis.imagem.store')}}" enctype="multipart/form-data" method="post">

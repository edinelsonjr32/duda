                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <a class="btn btn-success col-md-1 col-md-offset-11"  href="{{route('admin.proprietario.juridico.create')}}">
                                Adicionar
                            </a>
                        </div>
                        <!-- /.box-header -->
                                    ...
                                    @foreach ( $dados as $dado )
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <a class=" btn btn-block btn-success" href="{{route('admin.proprietario.juridico.detalhe', $dado->id)}}"><span class="fa fa-eye"></span></a>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <a class=" btn btn-block btn-primary" href="{{route('admin.proprietario.juridico.edit', $dado->id)}}"><span class="fa fa-pencil"></span></a>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <a  class=" btn btn-block btn-danger" href="{{route('admin.proprietario.juridico.destroy', $dado->id)}}"><span class="fa fa-trash"></span></a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>

            ...
            <div class="row">
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body no-padding">
                            ...
                            <!--<li><a href=""><i class="fa fa-envelope-o"></i> Enviadas <span class="label label-danger pull-right"></span></a></li>-->
                                ...
                                <li><a href="#"><i class="fa fa-trash-o"></i> Excluidas <span class="label label-info pull-right">{{$emailsExcluidos}}</span></a></li>
                            </ul>
                        </div>
                        <!-- /.box-body -->
                    </div>
                ...
                <div class="col-md-10">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Mensagens Excluidas</h3>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    @foreach($emails as $dado)
                                            <tr>
                                                ...
                                                <td class="mailbox-name col-md-2"><a href="read-mail.html" class="text-danger">{{$dado->nome}}</a></td>
                                                <td class="mailbox-subject col-md-7 text-danger" ><b >{{$dado->titulo}}</b> - {{substr($dado->mensagem, 0, 30) . '...'}}
                                                    @if($dado->lido == 1)
                                                        <a href="#" class="text-success"><i class="fa fa-check"></i> Visualizado</a>
                                                    @else

                                                    @endif

                                                </td>
                                                <td class="mailbox-date col-md-2" class="text-danger">
                                                    <b class="text-danger">{{date('H:i -  d/m/Y ', strtotime($dado->created_at)) . "  -  "}}</b>
                                                    <a href="{{route('admin.email.recuperar', $dado->id)}}" class="text-success"> <i class="fa   fa-check-square-o "></i></a>
                                                </td>
                                            </tr>
                                    @endforeach

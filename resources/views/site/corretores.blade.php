...
<div class="super_container">
					...
					<div class="header_content d-flex flex-row align-items-center justify-content-start">
						...
						<nav class="main_nav">
							<ul>
                                ...
                                <li class="active"><a href="{{route('site.corretores')}}">Corretores</a></li>
				...
				<div class="row">
					<div class="col">
						<div class="home_content d-flex flex-row align-items-end justify-content-start">
							<div class="home_title">Corretores</div>
    ...
    <div class="about">
        <div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title">Nossas Corretoras</div>
				</div>
			</div>
                ...
                @foreach($corretores as $corretor)
                    <div class="col-lg-3 col-md-6">
                        <div class="realtor_outer">
                            <div class="realtor">
                                <div class="realtor_image"><img src="{{ url("/imovel/images/corretor/{$corretor->path}") }}" alt=""></div>
                                <div class="realtor_body">
                                    <div class="realtor_title">{{$corretor->nome}}</div>
                                    <div class="realtor_subtitle">{{$corretor->codigo}}</div>
                                    <div class="realtor_subtitle">{{$corretor->telefone}}</div>
                                </div>
                            </div>
                        </div>
                    </div>

...
<div class="super_container">
					...
					<div class="header_content d-flex flex-row align-items-center justify-content-start">
						...
						<nav class="main_nav">
							<ul>
                                ...
                                <li class="active"><a href="{{route('site.imoveis')}}">Imóveis</a></li>
	...
	<div class="properties">
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title">{{$count}} Imóveis Para Alugar</div>
            ...
            <div class="row">
                <div class="col">
                    <div class="section_title">{{$count2}} Imóveis Para Venda</div>
                    <div class="section_subtitle">Busque seu imóvel aqui</div>
                </div>
            </div>
            <div class="row properties_row">
                <!-- Property -->
                @foreach($dadosImoveis2 as $dado)
                    <div class="col-xl-4 col-lg-6 property_col">
                        <div class="property">
                            <div class="property_image">
                                <img src="{{ url("/imovel/images/{$dado->path}") }}" alt="" style="width: 400px; height: 300px" >

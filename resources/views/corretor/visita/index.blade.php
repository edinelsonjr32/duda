                            ...
                            <div class="modal fade" id="modal-default">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        @endif
                                        <form method="POST" action="{{ route('corretorvisita.store') }}">
                                            @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 col-xs-4">
                                                        <a class=" btn btn-block btn-primary" href="{{route('corretorvisita.edit', $dado->id)}}"><span class="fa fa-pencil"></span></a>
                                                    </div>
                                                    <div class="col-md-4 col-xs-4">
                                                        <a  class=" btn btn-block btn-danger" href="{{route('corretor.visita.destroy', $dado->id)}}"><span class="fa fa-trash"></span></a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>

            ...
            <div class="row">
                <div class="col-xs-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($imovel->aluguel == 1)
                                                ...
                                                <a class=" btn btn-block btn-success" href="{{route('corretor.imoveis.aluguel.detail', $imovel->id)}}"><span class="fa fa-eye"></span></a>

                                            @elseif($imovel->venda == 1)
                                                <a class=" btn btn-block btn-success" href="{{route('corretor.imoveis.venda.detail', $imovel->id)}}"><span class="fa fa-eye"></span></a>
                    ...
                    <div class="box box-warning ">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form action="{{route('corretor.proprietario.juridico.documento.store')}}" enctype="multipart/form-data" method="post">
                            ...
                            @foreach($documentos as $dado)
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <a type="button" href="{{route('corretor.proprietario.fisico.documento.download', ['id' => $dado->id])}}" class="btn btn-block btn-success"><span class="fa fa-download"></span></a>
                                            </div>
                                            <div class="col-md-6">
                                                <a type="button" href="{{route('corretor.proprietario.fisico.documento.delete', ['id' => $dado->id])}}" class="btn btn-block btn-danger"><span class="fa fa-trash"></span></a>
                                            </div>
                                        </div>

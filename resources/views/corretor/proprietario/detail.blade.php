                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            ...
                            <h3 class="profile-username text-center">Imóveis</h3>
                            <table class="table table-dark">
                                ...
                                <tr>
                                    <td>{{$imovel->id}}</td>
                                    <td>{{$imovel->titulo}}</td>
                                    <td><a class=" btn btn-block btn-success" href="{{route('corretor.imoveis.detail', $imovel->id)}}"><span class="fa fa-eye"></span></a></td>
                                </tr>
                                @endforeach
                            </table>
                        </div>
                    ...
                    <div class="box box-warning ">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form action="{{route('corretor.proprietario.documento.store')}}" enctype="multipart/form-data" method="post">
                            ...
                            @foreach($documentos as $dado)
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <a type="button" href="{{route('corretor.proprietario.documento.download', ['id' => $dado->id])}}" class="btn btn-block btn-success"><span class="fa fa-download"></span></a>
                                            </div>
                                            <div class="col-md-6">
                                                <a type="button" href="{{route('corretor.proprietario.documento.delete', ['id' => $dado->id])}}" class="btn btn-block btn-danger"><span class="fa fa-trash"></span></a>
                                            </div>
                                        </div>

...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="/administrativo/index"><i class="fa fa-dashboard"></i> Corretor</a></li>
        <li><a href="/administrativo/imoveis/index"><i class="fa fa-home"></i> Imóvel</a></li>
        <li class="active"> <i class="fa fa-eye"></i>  detalhe</li>
      </ol>
    </section>
                            ...
                            <div class="box-footer no-padding">
                                <ul class="nav nav-stacked">
                                    ...
                                    @elseif($dados->taxas_extras !== null)
                                        <li><a href="#">Taxa Rateio<span class="pull-right badge bg-green">R${{number_format($dados->taxas_extras, 2, ',', '.')}}</span></a></li>
                                    @endif

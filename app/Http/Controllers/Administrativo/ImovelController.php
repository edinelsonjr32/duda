...
class ImovelController extends Controller
{
    ...
    public function indexVenda()
    {
        ...
        return view('administrativo.imovel.venda.index', ['dadosImoveis' =>$dadosImoveis]);
    }
    ...
    public function indexAluguel()
    {
        ...
        return view('administrativo.imovel.aluguel.index', ['dadosImoveis' =>$dadosImoveis]);
    }
    /**
    ...
    public function detailVenda($id)
    {
        ...
        if ($dadosImovel == '[]'){
            return redirect()->route('administrativo.imoveis.venda.index')->with(['class-color' => 'alert-danger', 'message' => 'Erro na busca de Imóvel, tente novamente!']);
        }else{
            ...
            return view(
                'administrativo.imovel.venda.detail',
                [
    ...
    public function detailAluguel($id)
    {
        ...
        if ($dadosImovel == '[]'){
            return redirect()->route('administrativo.imoveis.aluguel.index')->with(['class-color' => 'alert-danger', 'message' => 'Erro na busca de Imóvel, tente novamente!']);
        }else{
            ...
            return view(
                'administrativo.imovel.aluguel.detail',
                [
                    'dadosImovel' => $dadosImovel,
                    'imagensImoveis' => $imagensImoveis,
                    'contador1' => $contador1,

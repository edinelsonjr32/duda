...
class ProprietarioController extends Controller
{
    ...
    public function indexJuridico()
    {
        ...
        return view('corretor.proprietario.juridica.index', ['dados' => $dadosProprietarios]);
    }
    ...
    {
        return view('corretor.proprietario.juridica.create');
    }
    ...
    public function storeJuridico(Request $request)
    {
        ...
        Proprietario::create(
            ...
            return redirect(route('corretor.proprietario.juridico.index'))->with(['class-color' => 'alert-success', 'message' => 'Proprietário cadastrado com sucesso!']);
        }else{
            return redirect(route('corretor.proprietario.juridico.index'))->with(['class-color' => 'alert-danger', 'message' => 'Erro no cadastro de Proprietário!']);
        }
    }
    ...
    public function editJuridico($id)
    {
        ...
        return  view('corretor.proprietario.juridica.edit', ['dadosProprietario' => $dadosProprietario]);
    }
    ...
    public function updateJuridico(Request $request, $id)
    {
        ...
        return redirect()->route('corretor.proprietario.juridico.index')->with(['class-color' => 'alert-success', 'message' => 'proprietário atualizado com sucesso!']);
    }
    ...
    public function documentoDeleteJuridico($id)
    {
        ...
        if ($documento->delete()){
            ...
            return redirect()->route('corretor.proprietario.juridico.detalhe', $idProprietario)->with(['class-color' => 'alert-success', 'message' => 'imóvel  cadastrado com sucesso!']);
        }
    }
    public function documentoStoreJuridico( Request $request)
    {
        ...
        return redirect()->route('corretor.proprietario.juridico.detalhe', $idImovel)->with(['class-color' => 'alert-success', 'message' => 'imóvel  cadastrado com sucesso!']);;
    ...
    public function destroyJuridico($id)
    {
        ...
        if ($proprietario->delete()){
            ...
            return redirect()->route('corretor.proprietario.juridico.index')->with(['class-color' => 'alert-success', 'message' => 'Proprietário removido com sucesso!']);
        }else{
            return redirect()->route('corretor.proprietario.juridico.index')->with(['class-color' => 'alert-danger', 'message' => 'Proprietário não foi removido!']);
        }
    ...
    public function indexFisica()
    {
        ...
        return view('corretor.proprietario.fisica.index', ['dados' => $dadosProprietarios]);
    }
    ...
    {
        return view('corretor.proprietario.fisica.create');
    }
    ...
    public function storeFisica(Request $request)
    {
        ...
        Proprietario::create(
            ...
            return redirect(route('corretor.proprietario.fisico.index'))->with(['class-color' => 'alert-success', 'message' => 'Proprietário cadastrado com sucesso!']);
        }else{
            return redirect(route('corretor.proprietario.fisico.index'))->with(['class-color' => 'alert-danger', 'message' => 'Erro no cadastro de Proprietário!']);
        }
    }
    ...
    public function detalheFisica($id)
    {
        ...
        return view('administrativo.proprietario.fisica.detail', ['proprietario' => $proprietario, 'documentos' => $documentos, 'imoveisVenda' => $imoveisVenda, 'imoveisAluguel'=> $imoveisAluguel]);
    }
    ...
    public function editFisica($id)
    {
        ...
        return  view('corretor.proprietario.fisica.edit', ['dadosProprietario' => $dadosProprietario]);
    }
    ...
    public function updateFisica(Request $request, $id)
    {
        ...
        return redirect()->route('corretor.proprietario.fisico.index')->with(['class-color' => 'alert-success', 'message' => 'proprietário atualizado com sucesso!']);
    }
    ...
    public function documentoDeleteFisica($id)
    {
        ...
        if ($documento->delete()){
            Storage::disk('public')->delete($nomePath);
            return redirect()->route('corretor.proprietario.fisico.detalhe', $idProprietario)->with(['class-color' => 'alert-success', 'message' => 'imóvel  cadastrado com sucesso!']);
        }
    }
    public function documentoStoreFisica( Request $request)
    {
        ...
        return redirect()->route('corretor.proprietario.fisico.detalhe', $idImovel)->with(['class-color' => 'alert-success', 'message' => 'imóvel  cadastrado com sucesso!']);;
    ...
    public function destroyFisica($id)
    {
        ...
        if ($proprietario->delete()){
            ...
            return redirect()->route('corretor.proprietario.fisico.index')->with(['class-color' => 'alert-success', 'message' => 'Proprietário removido com sucesso!']);
        }else{
            return redirect()->route('corretor.proprietario.fisico.index')->with(['class-color' => 'alert-danger', 'message' => 'Proprietário não foi removido!']);
        }
